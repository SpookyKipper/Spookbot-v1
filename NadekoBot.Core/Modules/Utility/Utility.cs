        ...
        public async Task Stats()
        {
            ...
            await ctx.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"Spookbot v1.5")
                                          .WithUrl("https://spookybots.ml")
                                          .WithIconUrl("https://beta.spookybots.ml/boticon.png"))
                                          .WithImageUrl("https://spookybots.ml/stats.png")
                    .AddField(efb => efb.WithName(GetText("author")).WithValue($"Spooky Kipper#4202").WithIsInline(true))
                    ...
                    .AddField(efb => efb.WithName(GetText("presence")).WithValue(
                        GetText("presence_txt",
                            _bot.GuildCount, _stats.TextChannels, _stats.VoiceChannels, "%users% Users")).WithIsInline(true))//.ConfigureAwait(false)
                  //  .AddField(efb => efb.WithName($"Useful Links").WithValue($"Bot homepage\nhttps://spookybots.ml\ccommand List\n https://spookybots.ml/cmds\n Spookbot Support Server\n https://url.kipper.ml/discord\n Invite Spookybot\n https://spookybots.ml/invite")).WithIsInline(true));
                    .AddField(efb => efb.WithName($"Useful Links").WithValue($"[Bot homepage](https://spookybots.ml) | [Bot Command List](https://spookybots.ml/cmds) | [Spookbot Support Server](https://discord.gg/DFuq3pjV6X)\n[Invite Spookbot](https://discordapp.com/oauth2/authorize?client_id=843312372797931530&scope=bot&permissions=66186303) | [Changelogs](https://spookybots.ml/changelogs) | [Vote for the bot](https://www.kipper.ml/dcvote)").WithIsInline(true))
                    .AddField(efb => efb.WithName($"Thanks").WithValue($"Kwoth#2452 for making NadekoBot.").WithIsInline(true)));}
